...
DGX
	...
	v08(80, 2 hops, 1 CNN)
	v09(20, single hop, 1 CNN)
	v09(20, 2 hops, parallel, concat, 1 CNN)
Mine
	v01
	v02
...
--num_segments 8 --hop 2 --result_path /raid/users/km/SthSth/Experiments/TRN/v10_MemNNQueryNN_2hops_concat_parallel_1CNN/ --workers 20 --num_CNNs 1
