...
# dgx
python main.py something RGB --consensus_type MemNN --batch-size 128 --gpus 0 1 2 3 --root_path /raid/users/km/SthSth/ --num_segments 8 --hop 1 --result_path /raid/users/km/SthSth/Experiments/TRN/v03_temp
